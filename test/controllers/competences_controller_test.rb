...
class CompetencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create competence" do
    assert_difference("Competence.count") do
      post competences_url, params: { competence: { description: @competence.description, name: @competence.name } }
    end
  ...
  test "should update competence" do
    patch competence_url(@competence), params: { competence: { description: @competence.description, name: @competence.name } }
